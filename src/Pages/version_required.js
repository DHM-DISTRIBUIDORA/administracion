                ...
                <SView width={150} height={50} center card style={{
                    ...
                    onPress={() => {
                        if (Platform.OS == "android") {
                            Linking.openURL("https://play.google.com/store/apps/details?id=com.distribuidora_dhm_app")
                        } else if (Platform.OS == "ios") {
                            Linking.openURL("https://apps.apple.com/us/app/dhm-distribuidora/id6451025877")
                        }
