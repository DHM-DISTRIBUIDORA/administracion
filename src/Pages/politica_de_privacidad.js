...
class index extends Component {
    render() {
        ...
        >
            <Container >
                <SHr height={40} />
                <SText bold center fontSize={18} >{`TÉRMINOS Y CONDICIONES DE USO PARA LA APLICACIÓN DHM`}</SText>
                <SHr height={20} />
                <SView col={"xs-12"}  >
                ...
                <SText style={{ textAlign: 'justify' }}>
                    Bienvenido a DHM Distribuidora. Esta política de privacidad explica cómo recopilamos, utilizamos, compartimos y protegemos la información personal de los usuarios de nuestra aplicación. DHM Distribuidora se compromete a proteger su privacidad y a asegurar que sus datos personales sean manejados de manera segura.
                </SText>
                <SHr height={10} />
                ...
                <SText style={{ textAlign: 'justify' }}>
                    Esta política de privacidad está disponible directamente desde nuestra página de listado en la Play Store y dentro de la aplicación "DHM Distribuidora" bajo la sección de Ajustes - Política de Privacidad.
                </SText>
                <SHr height={20} />
                ...
                <SText style={{ textAlign: 'justify' }}>
                    DHM Distribuidora puede modificar esta política de privacidad periódicamente. Cualquier cambio será comunicado a través de nuestra aplicación o por correo electrónico.
                </SText>
                <SHr />
