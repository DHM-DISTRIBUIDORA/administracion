    ...
    getTable() {
        ...
        return <STable2
            ...
            header={[
                ...
                { key: "rebotado/monto", width: 60, label: "Monto total", width: 70, sumar: true, renderTotal: a => parseFloat(a ?? 0).toFixed(2), render: a => parseFloat(!a ? 0 : a).toFixed(2), cellStyle: { textAlign: "right" } },
