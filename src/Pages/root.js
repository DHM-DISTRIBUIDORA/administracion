        ...
        return <SPage preventBack hidden onRefresh={async (resolve) => {
            ...
            <SView col={"xs-12"} flex >
                <MenuPages path={"/"} permiso={"page"}>
                    ...
                    <MenuButtom label={"Permisos"} url={"/permissions"} icon={<SIcon name={"Ajustes"} />} /> 
                    <MenuButtom label={"Mi perfil"} url={"/perfil"} icon={this.getIconProfile()} />
                    {/* <MenuButtom label={"Dash"} url={"/dashboard"} icon={<SIcon name={"Vendedor"} />}/> */}
                    {/* <MenuButtom label={"Test"} url={"/blanco"} icon={<SIcon name={"Alert"} />} /> */}
                </MenuPages>
            </SView>
            {/* <SHr height={100} /> */}
        </SPage>
