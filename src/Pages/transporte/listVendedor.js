                ...
                return <>
                    <SView col={"xs-12"} row center>
                        <SView col={"xs-5"} center>
                            <SView col={"xs-12"} backgroundColor={STheme.color.card} row>
                                <SText fontSize={12} bold>Vendedor: </SText>
                                <SText fontSize={12}>{obj}</SText>
                            </SView>
                        </SView>
                        <SView col={"xs-5"} center>
                            <SButtom type='primary' styleText={{ color: STheme.color.text }}
                                onPress={() => {
                                    SNavigation.navigate("/transporte/listVendedorPedidos", {
                                        pk: this.idemp, fecha_inicio: this.state?.fecha_inicio, index: obj
                                    })
                                }}>VER PEDIDOS</SButtom>
                        </SView>
                    </SView>
